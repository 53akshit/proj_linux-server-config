...
ipaddress:13.126.102.64
SSH Port: 2200

#### Publicly available URL

[http://ec2-13-126-102-64.ap-south-1.compute.amazonaws.com](http://ec2-13-126-102-64.ap-south-1.compute.amazonaws.com)
...
Instructions for connecting from your terminal to the instance.
	...
	- Also, to sort out the initial login issue
		...
		- sudo service ssh restart
	- ssh grader@13.126.102.64 -p 2200 -i *key-pair.pem*
